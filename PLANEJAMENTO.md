...
- ⏭️ **Backlog restante (fase 1.x)**: player em background/MediaSession (excluído a pedido do usuário), transcrição (whisper — exige embutir whisper.cpp, decisão pendente), fase 2 sync desktop
